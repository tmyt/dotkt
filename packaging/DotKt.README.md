...
| `DotKt.Toolchain` | The compiler toolchain (`kotc`, `bir2cir`, `ilemit`, `facadegen`, `retarget`) + the frontend stdlib klib + the compile-time stdlib reference assembly. Build-only. |
