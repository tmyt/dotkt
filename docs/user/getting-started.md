...
current release is `0.9.10`, and pinning keeps a project on a known toolchain across feed updates:

```bash
dotnet new install DotKt.Templates::0.9.10
```
