...
newest version is `0.9.10-beta2`, a pre-release, and pinning keeps a project on a known toolchain
across feed updates:

```bash
dotnet new install DotKt.Templates::0.9.10-beta2
```
...
```xml
<Project Sdk="DotKt.Sdk/0.9.10-beta2">
  <PropertyGroup>
