...
2. `[KotlinInline]` cross-module splice: producer BirEmitter 1328 + isInlineWithLambda 1362; ilemit Program.cs 698/Metadata.cs 45; call site 3915-3929→inlineSpliceCall 2338-2358 (lambda body in CALLER scope = NLR mechanism); consumer ilemit EmitInlineSplice 3186-3232. Limits: statement-only (void 3231), no type-arg subst, extension-inline excluded (3925), local-name scoping unhandled (3164). Only roundtrip:281-309 exercises it.
