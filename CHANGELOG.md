...
- **Inherited inner-class construction now retains the selected enclosing-owner slot (#555).** kotc projects a
  derived enclosing-instance receiver through its frontend supertype graph before describing same-module and
  referenced constructors, preserving generic substitutions and exact same-arity overload selection.
