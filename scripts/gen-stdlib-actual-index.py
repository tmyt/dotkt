#!/usr/bin/env python3
"""Generate a COMPLETE index of `actual` declarations in libraries/stdlib/clr/, classified by
...
Regenerate after binding work:  python3 scripts/gen-stdlib-actual-index.py
"""
...
out.append(f"Generated by `scripts/gen-stdlib-actual-index.py` on {datetime.date.today().isoformat()}. "
           f"Source: `libraries/stdlib/clr/` ({len(files)} files, {total} `actual` declarations).\n")
