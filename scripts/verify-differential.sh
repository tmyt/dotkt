...
il-seq il-char il-sort il-getclass il-localdeleg il-langfeat il-ctorref il-localclass il-refcell il-annot il-props il-mixnum \
il-bymap il-bytearg il-chunk il-cmpord il-coerce il-comparable il-comparator il-cp il-ctor il-deleg il-deleg2 il-dsl il-duration il-exprbody il-ext il-for il-genbase il-gencolladd il-genctor il-genstatic il-gfac il-groupvalues il-iface il-inner il-langtail il-lazy il-loopjump il-math il-nested il-objgen il-overload il-overrideprop il-pair il-regex il-regexgroups il-regexreplace il-rwp il-samcmp il-seqfilter il-setlocalbox il-unsigned il-use il-valclass il-vis il-volatile il-xfaceimpl il-xprop \
il-boxgen il-mathabs il-pairtostr il-extprop il-defargs il-defargs2 il-pairnest \
il-genmax il-divmin il-nestlam il-genseq2 il-cwindowed il-cwindowedv \
