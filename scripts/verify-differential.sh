...
il-seq il-char il-sort il-funref il-extfunref il-getclass il-localdeleg il-langfeat il-mapdes il-ctorref il-collmore il-tryexpr il-localclass il-collops2 il-refcell il-annot il-props il-mixnum il-arrops \
il-arr il-blank il-bymap il-bytearg il-charminus il-charseq il-charseqs il-charseqx il-chunk il-closure il-cmpord il-coerce il-coll il-coll2 il-coll3 il-collrealkt il-colstr il-comparable il-comparator il-cp il-ctor il-customexc il-deleg il-deleg2 il-digittoint il-dsl il-duration il-emptymap il-enum il-enumbody il-enumrich il-exc il-excmap il-exprbody il-ext il-for il-genbase il-genclosure il-gencolladd il-genctor il-genhof il-genstatic il-gfac il-groupvalues il-hashset2 il-iface il-inline il-inline2 il-inline-nested-nlr il-inline-outerlabel il-inline-nlbreak il-inline-ownlabel il-inline-mutcapture il-inline-forward il-inner il-interpnull il-iscoll il-iter il-iterable il-lambda il-langtail il-lazy il-loopjump il-math il-mapfilter il-mapforin il-mapgen il-mapof1 il-maptostr il-mfclosure il-mflambda il-mutcoll il-mutset il-nan il-nancmp il-nested il-nestedstr il-nestedtry il-ntostr il-null il-nulltostr il-object il-objexpr il-objgen il-op il-ops il-overload il-overrideprop il-pair il-printlnnull il-rangein il-regex il-regexgroups il-regexreplace il-reqnn il-result il-rwp il-safecallnv il-samcmp il-scope il-seqfilter il-setlocalbox il-smartcast il-str il-strnum il-strops il-subseq il-substr il-throwexpr il-tryexprop il-trynullable il-unsigned il-use il-userrange il-valclass il-vis il-volatile il-whensubj il-xfaceimpl il-xinline il-xprop \
