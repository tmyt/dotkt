...
if [[ -n "$ILV" && -d "$REFDIR" ]]; then
	...
	#   • ifacesuspend — RUNS green (42) but ilverify flags CallAbstract in the synthesized interface-suspend
