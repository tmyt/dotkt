...
declare -A XFAIL_ILVERIFY=(
	...
	[collops2]="ilverify counterpart of run:collops2 — the generic callStatic (windowed<Int>) is emitted with 2 of 4 args (step/partialWindows defaults unfilled by ilemit's EmitArgsTyped typeArgs path). Pends the ilemit default-fill fix (Emitter.Expressions.cs:228)."
