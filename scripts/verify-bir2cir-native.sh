...
require '"ilemitCompatBir"' "ilemit-compatible CIR payload"
require '"k": "clr.newobj"' "lowered constructor call"
require '"k": "clr.call"' "lowered method call"
require '"k": "clrNew"' "ilemit-compatible constructor call"
require '"k": "clrInstance"' "ilemit-compatible instance call"
