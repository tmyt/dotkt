...
/// BadImageFormatException seen when one stage rewrites a dll while another (dll2klib/bir2cir) is loading the SAME
/// file. We write to a sibling temp file and rename over the target: a same-directory rename is atomic on every OS the
