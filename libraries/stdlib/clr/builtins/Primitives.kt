...
// Step-1 CLR stub mirroring the JVM `actual` declarations; bodies are `TODO` pending the `@Clr`/BCL
// binding step (see docs/design-stdlib-compilation.md "THE CANONICAL ROADMAP").

@file:Suppress("ACTUAL_WITHOUT_EXPECT", "NO_ACTUAL_FOR_EXPECT", "UNCHECKED_CAST", "NOTHING_TO_INLINE", "NO_ACTUAL_CLASS_MEMBER_FOR_EXPECTED_CLASS", "NON_ABSTRACT_FUNCTION_WITH_NO_BODY", "OVERRIDE_DEPRECATION", "DIVISION_BY_ZERO")
...
public actual class Long private constructor() : Number(), Comparable<Long> {
    ...
    /** Adds the other value to this value. */
    @kotlin.internal.IntrinsicConstEvaluation
    public actual operator fun plus(other: Byte): Long

    /** Adds the other value to this value. */
    @kotlin.internal.IntrinsicConstEvaluation
    public actual operator fun plus(other: Short): Long

    /** Adds the other value to this value. */
    @kotlin.internal.IntrinsicConstEvaluation
    public actual operator fun plus(other: Int): Long
    ...
    /** Subtracts the other value from this value. */
    @kotlin.internal.IntrinsicConstEvaluation
    public actual operator fun minus(other: Byte): Long

    /** Subtracts the other value from this value. */
    @kotlin.internal.IntrinsicConstEvaluation
    public actual operator fun minus(other: Short): Long

    /** Subtracts the other value from this value. */
    @kotlin.internal.IntrinsicConstEvaluation
    public actual operator fun minus(other: Int): Long
    ...
    /** Multiplies this value by the other value. */
    @kotlin.internal.IntrinsicConstEvaluation
    public actual operator fun times(other: Byte): Long

    /** Multiplies this value by the other value. */
    @kotlin.internal.IntrinsicConstEvaluation
    public actual operator fun times(other: Short): Long

    /** Multiplies this value by the other value. */
    @kotlin.internal.IntrinsicConstEvaluation
    public actual operator fun times(other: Int): Long
    ...
    /** Divides this value by the other value, truncating the result to an integer that is closer to zero. */
    @kotlin.internal.IntrinsicConstEvaluation
    public actual operator fun div(other: Byte): Long

    /** Divides this value by the other value, truncating the result to an integer that is closer to zero. */
    @kotlin.internal.IntrinsicConstEvaluation
    public actual operator fun div(other: Short): Long

    /** Divides this value by the other value, truncating the result to an integer that is closer to zero. */
    @kotlin.internal.IntrinsicConstEvaluation
    public actual operator fun div(other: Int): Long
    ...
    @SinceKotlin("1.1")
    @kotlin.internal.IntrinsicConstEvaluation
    public actual operator fun rem(other: Byte): Long
    ...
    @SinceKotlin("1.1")
    @kotlin.internal.IntrinsicConstEvaluation
    public actual operator fun rem(other: Short): Long
    ...
    @SinceKotlin("1.1")
    @kotlin.internal.IntrinsicConstEvaluation
    public actual operator fun rem(other: Int): Long
...
public actual class Float private constructor() : Number(), Comparable<Float> {
    ...
    // hashCode is intentionally NOT declared here (#168): like Int/Long, Float inherits the kotlin.Any universal
    // method, so a `.hashCode()` call routes through kotc's universal-method path to the CLR-native
    // System.Single.GetHashCode. The Kotlin contract needs only within-run + equals-consistency, not a specific
    // bit-based value; .NET Core 3+ normalizes all NaNs to one hash and both zeros together, so it is
    // equals-consistent with Kotlin's total-order structural equality (clrFloatEquals) — the legal -0.0f/+0.0f
    // hash collision compares unequal, which HashSet resolves correctly.
}
...
public actual class Double private constructor() : Number(), Comparable<Double> {
    ...
    // hashCode is intentionally NOT declared here (#168): like Int/Long, Double inherits the kotlin.Any universal
    // method, so a `.hashCode()` call routes through kotc's universal-method path to the CLR-native
    // System.Double.GetHashCode. The Kotlin contract needs only within-run + equals-consistency, not a specific
    // bit-based value; .NET Core 3+ normalizes all NaNs to one hash and both zeros together, so it is
    // equals-consistent with Kotlin's total-order structural equality (clrDoubleEquals) — the legal -0.0/+0.0
    // hash collision compares unequal, which HashSet resolves correctly.
}
