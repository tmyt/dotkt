...
// `demo.Plain`/`demo.hello` are compiled LOCALLY here AND injected from the referenced dll — the exact #15
// pathological overlap. The frontend "source wins" fix suppresses the injected copy; bir2cir must PREFER this local
