...
declare -A EXPECTED=(
	["tests/il"]=78   # GenericsTests g1..g6 (6) + InlineTests 17 (il-inline*/il-xinline) + CollectionsTests 16 + MapsTests 10 + StringsTests 22 (string/text family) + FloatTests 7 (float/IEEE family)
)
