...
declare -A EXPECTED=(
	["tests/il"]=178  # Generics 6 + Inline 17 + Collections 16 + Maps 10 + Strings 22 + Nullable 13 + Float 8 + Enum 5 + Exception 8 + Lambda 10 + ClrEvent 4 + LanguageCore 12 + Array 12 + GenericTypes 10 + Math 6 + MigratedM1{Ctor 2 + Comparison 3 + Char 3 + Numeric 2 + Collections 4 + Delegation 3 + Decl 2 = 19}
