...
declare -A EXPECTED=(
	["tests/il"]=187  # Generics 6 + Inline 19 + Collections 16 + Maps 10 + Strings 22 + Nullable 13 + Float 8 + Enum 5 + Exception 8 + Lambda 10 + ClrEvent 4 + LanguageCore 12 + Array 12 + GenericTypes 10 + Math 6 + Regex 7 + M3Inline 5 + M3Collections 2 + M3Language 7 + M3Delegates 5
