...
// single-threaded so the result is deterministic. It COMPLEMENTS MigratedM5PropsTests.atomicVolatile (store/load) by
...
class MigratedIntropCAtomicsTests {
    ...
    @TestAttribute
    fun atomics_interlockedByrefBinding() {
        val a = AtomicInt(10)
