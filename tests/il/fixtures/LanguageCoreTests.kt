...
class LanguageCoreTests {
    ...
    @TestAttribute
    fun interfaceCompanion_statics() {
    ...
    @TestAttribute
    fun operatorOverload_userDefined() {
        val a = OpVec(3, 4)
        val b = OpVec(1, 2)
    ...
    @TestAttribute
    fun operators_bitwiseShiftLoop() {
        var i = 0
        do { i = i + 1 } while (i < 3)
        assertEquals(3, i)             // 3
    ...
    @TestAttribute
    fun userMember_universalMethods() {
        val a = UmPoint(1, 2)
        val b = UmPoint(1, 2)
        val c = UmPoint(3, 4)
    ...
    @TestAttribute
    fun rangeIn_primitiveMembership() {
        riC = 0
