...
// migrate normally (not frozen). The tests/il .ktproj facadegen scan-imports pipeline injects the .NET Task
...
class MigratedIntropBTaskTests {
    ...
    @TestAttribute
    fun taskwhen_nestedGenericCombinators() {
