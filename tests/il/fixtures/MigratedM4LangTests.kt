...
class MigratedM4LangTests {
    ...
    @TestAttribute
    fun nncontract_nonNullContracts() {
        m4NncLog.clear()
    ...
    @TestAttribute
    fun pairnest_nestedCollectionToString() {
    ...
    @TestAttribute
    fun precond_requireCheckErrorTodo() {
        val acc = IntArray(1)
    ...
    @TestAttribute
    fun propref_callableReferences() {
        m4PrefX = 1
    ...
    @TestAttribute
    fun props_customAccessorsLateinit() {
        val b = M4PropsBox(10)
    ...
    @TestAttribute
    fun refcell_capturedVarPromotion() {
        var counter = 0
    ...
    @TestAttribute
    fun refcell_nullableValueTypeCell() {
