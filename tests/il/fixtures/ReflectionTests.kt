...
class ReflectionTests {
    ...
    @TestAttribute
    fun boundLiteral_reportsKotlinName() {
    ...
    @TestAttribute
    fun boundString_reportsKotlinName() {
    ...
    @TestAttribute
    fun unboundBuiltin_reportsKotlinName() {
    ...
    @TestAttribute
    fun genericClass_reportsRawName() {
    ...
    @TestAttribute
    fun userClass_reportsKotlinName() {
    ...
    @TestAttribute
    fun arrayBuiltins_reportKotlinName() {
