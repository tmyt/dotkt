...
class GenericTypesTests {
    @TestAttribute
    fun genbase_genericBaseInheritance() {
        val d = GbD(42)
    ...
    @TestAttribute
    fun genctor_secondaryCtorDelegation() {
    ...
    @TestAttribute
    fun geninherit_inheritedBaseMethod() {
    ...
    @TestAttribute
    fun genstatic_genericStdlibStatic() {
    ...
    @TestAttribute
    fun gencolladd_genericCollectionAdd() {
    ...
    @TestAttribute
    fun genlocalclass_capturingLocal() {
    ...
    @TestAttribute
    fun genfield_genericFieldAnchoring() {
        val c = GfCell(41)
    ...
    @TestAttribute
    fun objgen_capturingObjectLiteral() {
