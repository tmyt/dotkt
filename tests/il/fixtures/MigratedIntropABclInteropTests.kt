...
// 1:1 (see the `// <expected>` comments). These fixtures import real .NET types — the tests/il .ktproj runs the
...
class MigratedIntropABclInteropTests {
    ...
    @TestAttribute
    fun bclinject_genericFactoryCtorAndStatic() {
    ...
    @TestAttribute
    fun tlvalint_valueTypeObliviousValue() {
