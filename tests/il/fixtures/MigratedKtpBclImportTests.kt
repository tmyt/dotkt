...
// facadegen import scan injects the types. The UNIQUE coverage here (vs the StringBuilder-only MigMInteropTests and
...
class MigratedKtpBclImportTests {
    @TestAttribute
    fun import_bclStringBuilderAndMath() {
