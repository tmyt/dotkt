...
// comments). These fixtures import real .NET types via the tests/il .ktproj facadegen scan-imports pipeline.
//
...
class MigratedIntropAGenericsTests {
    ...
    @TestAttribute
    fun forin_netEnumerableForLoop() {
        val l = List<Int>()
    ...
    @TestAttribute
    fun gendelegate_lambdaToGenericDelegateCtor() {
    ...
    @TestAttribute
    fun jsongeneric_genericMethodInteropSibling() {
    ...
    @TestAttribute
    fun netenumbound_boundEnumTypeParam() {
