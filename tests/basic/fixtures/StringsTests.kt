...
class StringsTests {
    ...
    @TestAttribute
    fun crossFile() {
        // Cfg / banner are declared in the SIBLING file StringCrossFileSupport.kt (same assembly) — the #149-1
