...
class EscapingSuspendCarrierOuterCaptureCollision(private val base: Int) {
    fun run(__outer: Int): Int = escapingSuspendCarrierWrap(5) { value ->
        escapingSuspendCarrierAdd(base + __outer, value)
    }
}
