...
class CorAColdMemberTests {
    @TestAttribute
    fun coldInst_instanceAndCrossFileSuspendCalls() {
    ...
    @TestAttribute
    fun coldSuper_inheritedSuspendMemberDispatch() {
    ...
    @TestAttribute
    fun coldVirt_genericClassInstanceMember() {
    ...
    @TestAttribute
    fun coRestrict_userRestrictsSuspensionScope() {
    ...
    @TestAttribute
    fun coMainDrain_genuinelySuspendingMainBlocks() {
